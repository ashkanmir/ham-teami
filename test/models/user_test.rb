...
class UserTest < ActiveSupport::TestCase
  def setup
    @user = User.create(name:"Example User", email:"user@example.com", password: "foobar", password_confirmation: "foobar", city: "tehran", exp: "yes", work: "programmer", about: "ashmiri ashmiri")
  end
